...
public static class CardAssetSetup
{
    ...
    {
        // Items
        ("Áo giáp",  CardType.Item, CardEffectType.ItemArmor,  0, 3,
         "Assets/Sprites/item/aogiap - Copy (2).png",
         "Tăng 1 điểm Phòng thủ vĩnh viễn."),
        ("Binh khí", CardType.Item, CardEffectType.ItemWeapon, 0, 3,
         "Assets/Sprites/item/binhkhi - Copy (2).png",
         "Tăng 1 điểm Tấn công vĩnh viễn."),
        ("Thuốc bổ",  CardType.Item, CardEffectType.ItemPotion, 0, 3,
         "Assets/Sprites/item/thuoc - Copy (2).png",
         "Tăng 1 điểm Thể lực tối đa. Có thể hồi Thể lực mỗi vòng, không vượt tối đa."),

        // Actions
        ("Ăn xin",           CardType.Action, CardEffectType.ActionBeg,         1, 2,
         "Assets/Sprites/actions/anxin.png",
         "Xin mỗi người chơi 1 lá bài, họ tự chọn lá bỏ thí."),
        ("Cải tử hoàn sinh", CardType.Action, CardEffectType.ActionRevive,       2, 2,
         "Assets/Sprites/actions/caituhoansinh.png",
         "Hủy toàn bộ lá bài đang sở hữu để hồi sinh 1 người chơi đã bị loại."),
        ("Chạy giặc",        CardType.Action, CardEffectType.ActionFlee,         1, 2,
         "Assets/Sprites/actions/chaygiac.png",
         "Khi có sự kiện Giặc ngoại xâm, bạn không bị mất lá bài nào."),
        ("Ăn trộm",          CardType.Action, CardEffectType.ActionSteal,        1, 2,
         "Assets/Sprites/actions/trom - Copy (2).png",
         "Lén lút đột nhập, lấy 1 lá bài của người chơi khác."),
        ("Thuốc hồi phục",   CardType.Action, CardEffectType.ActionHeal,         1, 3,
         "Assets/Sprites/actions/thuochoiphuc - Copy - Copy.png",
         "Hồi phục 1 điểm Khí huyết."),
        ("Thuốc độc",        CardType.Action, CardEffectType.ActionPoison,       2, 2,
         "Assets/Sprites/actions/thuocdoc - Copy (2).png",
         "Chọn 1 người chơi để hạ độc; người đó giảm 1 Khí huyết liên tục 3 vòng kể từ vòng sau."),
        ("Thuốc đảo lộn",    CardType.Action, CardEffectType.ActionSwapStats,    1, 2,
         "Assets/Sprites/actions/thuocdaolon - Copy (2).png",
         "Chọn 1 người chơi, đảo chỗ giá trị Tấn công và Phòng thủ của người đó."),
        ("Thầy bùa",         CardType.Action, CardEffectType.ActionExorcism,     1, 2,
         "Assets/Sprites/actions/thaybua - Copy (2).png",
         "Mời thầy bùa, diệt trừ Oán linh hoặc khiến Oán linh ám người chơi khác."),
        ("Thầy bói",         CardType.Action, CardEffectType.ActionFortune,      1, 2,
         "Assets/Sprites/actions/thayboi - Copy (2).png",
         "Mời thầy bói, xem trước 3 lá bài trên deck."),
        ("Phản đòn",         CardType.Action, CardEffectType.ActionCounter,      1, 2,
        ...
        ("Oán linh",         CardType.Action, CardEffectType.ActionCurse,        1, 2,
         ...
         "Triệu hồi oán linh, ám 1 người chơi; người bị ám yếu đuối, Thể lực tối đa bị khóa ở 2."),
        ...
        // Events
        ("Hạn hán",              CardType.Event, CardEffectType.EventDrought,    0, 2,
         "Assets/Sprites/events/hanhan.png",
         "Hạn hán gây mất mùa, đói kém — -3 Thể lực hiện tại với tất cả người chơi."),
        ("Giặc ngoại xâm",       CardType.Event, CardEffectType.EventInvasion,   0, 2,
         "Assets/Sprites/events/giac - Copy (2).png",
         "Giặc kéo đến cướp phá, mỗi người chơi phải hủy 2 lá bài bất kỳ."),
        ("Góp gạo thổi cơm chung", CardType.Event, CardEffectType.EventShareRice, 0, 2,
